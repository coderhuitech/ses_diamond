...
class New_transaction_controller extends CI_Controller {
	...
	function save_lc_received(){
		...
		$row_array['transaction_no']=anchor_popup('advance_report_controller/show_lc_receipt_report?lc_receipt_id='.$result['transaction_no'], $result['transaction_no']);
	...
	function save_gold_receipt(){
		...
		$row_array['success']=1;
		$row_array['receipt_no']=anchor_popup('advance_report_controller/sales_gold_receipt_report?gold_receipt_id='.$result['receipt_no'], $result['receipt_no']);
