$(function(){
	$('#show-jobs').live('click',function(){
		var request=$.ajax({
		  				type:'get',
		   				url: base_url+"/job_controller/show_jobs_for_topup_pan_ajax",
						data: {},
						beforeSend:function(){},
	...
	$('.job-phseII-div').live('click',function(){
		...
		var request=$.ajax({
		  				type:'get',
		   				url: base_url+"/job_controller/select_job_by_job_id_for_topup_pan_ajax",
						data: {job_id: job_id},
						beforeSend:function(){},
		   				success: function(data, textStatus, xhr) {
								//$('#result-div').html(data);
	...
	$('#submit').live('click',function(event){
		...
		var panID=parseInt($('#pan-id').text());
		...
		$.msgBox({
	    	...
	    	success: function (result) {
	        	if (result == "Yes") {
					...
					var request=$.ajax({
		  				type:'post',
		   				url: base_url+"/job_controller/save_topup_pan_ajax",
