$(function () {
    $('#working-div').on('click','#show-receipt-details',function(event){
        event.preventDefault();
        var request=$.ajax({
            type:'get',
            url: base_url+"/advance_report_controller/show_gold_receipt_details",
            data: {gold_receipt_id: $('#gold-receipt-number').val()},//end of data
            beforeSend:function(){},
