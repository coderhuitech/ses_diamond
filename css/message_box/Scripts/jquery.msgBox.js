...
var urlAux2 = url2.split('/');

var img_url2=urlAux2[3]+'/'+'JS'+'/'+'message_box'+"/"+'Images'+"/";
...
function msg (options) {
    ...
    switch (options.type) {
        case "alert":
            image = img_url+"/alert.png";
            break;
        case "info":
            image = img_url+"/info.png";
            break;
        case "error":
            image = img_url+"/error.png";
            break;
        case "confirm":
            image = img_url+"/confirm.png";
            break;
        default:
            image = img_url+"/alert.png";
    }
    ...
    var divContainer = "<div class=\"msgBoxContainer\"><div id=" + divMsgBoxImageId + " class=\"msgBoxImage\"><img src=\"" +img_url+"/" + image + "\"/></div><div id=" + divMsgBoxContentId + " class=\"msgBoxContent\"><p><span>" + options.content + "</span></p></div></div>";
    ...
    function show() {
        ...
        //divMsgBox.css("background-image", "url('msgBoxBackGround.png')");
		divMsgBox.css("background-color", "red");
